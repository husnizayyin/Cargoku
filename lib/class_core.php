...
// *************************************************************************
  ...
  class Core
  {
	  ...
	  const consproductTable = "cons_products";
      ...
      {
          $sql = "SELECT * FROM " . self::cTable . " ORDER BY s_name ASC";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT a.id, a.order_inv, a.r_name, a.origin_port, a.status_courier, a.created, a.r_hour, a.destination_port, a.courier, a.payment_status, a.username, s.mod_style, s.color FROM add_container a, styles s WHERE a.status_courier=s.mod_style AND a.act_status='3'  ORDER BY a.id DESC";
          $row = self::$db->fetch_all($sql);
          return ($row) ? $row : 0;
      }
	  ...
	  $sql = "SELECT a.id, a.order_inv, a.r_name, a.r_qnty, a.r_dest, a.r_city, a.country, a.city, a.courier, a.service_options, a.payment_status, a.pay_mode, a.created, a.status_courier, a.s_name, s.mod_style, s.color  FROM add_courier a, styles s WHERE a.status_courier=s.mod_style AND a.act_status='1'  ORDER BY a.id DESC";
          $row = self::$db->fetch_all($sql);
	  ...
	  $sql = "SELECT a.id, a.idcon,a.order_inv, a.tracking,a.r_name, a.r_dest, a.c_address, a.r_qnty, a.r_weight, a.c_driver,a.created, a.status_courier, a.code_off, a.act_status, s.mod_style, s.color, b.order_invs, b.order_cons, b.idcon, b.trackings, b.r_descriptions  
			  FROM consolidate a, styles s, cons_products b WHERE a.status_courier=s.mod_style AND a.tracking=b.trackings AND a.act_status='0' ORDER BY a.id DESC";
          $row = self::$db->fetch_all($sql);
	  ...
	  $sql = "SELECT a.id, a.idcon,a.order_inv, a.r_name, a.r_dest, a.c_address, a.r_qnty, a.r_weight, a.c_driver,a.created, a.status_courier, a.code_off, b.order_invs, b.order_cons, b.idcon, b.r_descriptions 
			  FROM consolidate a, cons_products b WHERE a.tracking=b.trackings  ORDER BY a.id DESC";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT * FROM " . self::cTable . " WHERE status_courier = 'Pending' LIMIT 10 ";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT a.id, a.order_inv, a.s_name, a.email, a.status_courier, a.created, a.r_hour, a.r_costtotal, s.mod_style, s.color FROM add_courier a, styles s WHERE a.status_courier=s.mod_style  AND a.act_status='1' ORDER BY a.id ASC";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT a.id, a.order_inv, a.s_name, a.email, a.status_courier, a.r_costtotal, s.mod_style, s.color FROM add_courier a, styles s WHERE a.status_courier=s.mod_style  AND a.status_courier='Pending' ORDER BY a.id ASC";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT a.id, a.order_inv, a.s_name, a.email, a.status_courier, a.reasons, s.mod_style, s.color FROM add_courier a, styles s WHERE a.status_courier=s.mod_style  AND a.status_courier='Rejected' ORDER BY a.id ASC";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT a.id, a.order_inv, a.s_name, a.email, a.deliver_date, a.delivery_hour, a.name_employee, a.status_courier, a.r_costtotal, s.mod_style, s.color FROM add_courier a, styles s WHERE a.status_courier=s.mod_style  AND a.status_courier='Delivered' ORDER BY a.id ASC";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT a.id, a.order_inv, a.r_name, a.r_email, a.deliver_date, a.delivery_hour, a.name_employee, a.status_courier, a.r_costtotal, s.mod_style, s.color FROM consolidate a, styles s WHERE a.status_courier=s.mod_style  AND a.status_courier='Delivered' ORDER BY a.id ASC";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT * FROM " . self::cTable . " WHERE status_courier='Delivered' AND act_status='2' ORDER BY id ASC";
          $row = self::$db->fetch_all($sql);
      ...
      {
          $sql = "SELECT * FROM detail_container, add_container WHERE add_container.id=detail_container.idcon";
          $row = self::$db->fetch_all($sql);
      ...
      public function getCounton()
      {
          ...
          $sql = "SELECT COUNT(id) as total FROM " . self::cTable . "WHERE status_courier = 'Pending'";
          $row = self::$db->fetch_all($sql);
      ...
      public function getTrack_post()
      {
		  if(isset($_POST['submit'])){
			...
			$order_inv = sanitize($_POST['order_inv']);
				...
				$sql = "SELECT * FROM " . self::cTable ." WHERE order_inv = '$order_inv'";
				  $row = self::$db->fetch_all($sql);
				   return ($row) ? $row : 0;
			}
	  } 
      ...
      public function getTrack_post_history()
      {
		  if(isset($_POST['submit'])){
			...
			$sql = "SELECT * FROM " . self::ctrackTable . " WHERE order_track = '$order_track' ORDER BY id DESC";
			  $row = self::$db->fetch_all($sql);
			   return ($row) ? $row : 0;
			}
	  }  
      ...
      public function activateTwilio()
      {
		  ...
		  (self::$db->affected()) ? Filter::msgOk('<script type="text/javascript"> window.location="tools.php?do=sms";</script><span>Success!</span>SMS Twilio have been successfully activated.', false):'<script type="text/javascript"> window.location="tools.php?do=sms";</script><span>Success!</span>SMS Twilio have been successfully activated.';
      }
      ...
      public function activateNexmo()
      {
		  ...
		  (self::$db->affected()) ? Filter::msgOk('<script type="text/javascript"> window.location="tools.php?do=sms";</script><span>Success!</span>SMS Nexmo have been successfully activated.', false):'<script type="text/javascript"> window.location="tools.php?do=sms";</script><span>Success!</span>SMS Nexmo have been successfully activated.';
