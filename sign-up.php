    ...
    <div class="row">
    	<div class="col-lg-7 m-auto text-center">
			 <div class="card box-shadow-v2 bg-white u-of-hidden">
				...
				<?php else:?>
			 	<h3 class="bg-primary m-0 py-3 text-white"><?php echo $lang['langs_010113'] ?></h3>
					...
					<form id="admin_form" method="post">
						...
						<div class="input-group u-rounded-50 border u-of-hidden u-mb-20">
							...
							<input type="text" class="form-control border-0 p-3" name="fname" placeholder="<?php echo $lang['langs_010118'] ?>">
							<div class="input-group-addon bg-white border-0 pl-4 pr-0">
								<span class="icon icon-User text-primary"></span>
							</div>
							<input type="text" class="form-control border-0 p-3" name="lname" placeholder="<?php echo $lang['langs_010119'] ?>">
						</div>
						
						<div class="input-group u-rounded-50 border u-of-hidden u-mb-20">
							<input class="form-control border-0 p-3" name="code_phone" placeholder="<?php echo $lang['langs_010120'] ?>" list="browsersS" autocomplete="off" required="required">
						...
						<div class="input-group u-rounded-50 border u-of-hidden u-mb-20">
							...
							<input type="text" class="form-control border-0 p-3" name="address" placeholder="<?php echo $lang['langs_010122'] ?>">
						</div>
						
						<div class="input-group u-rounded-50 border u-of-hidden u-mb-20">
							<input class="form-control border-0 p-3" name="country"  placeholder="<?php echo $lang['langs_010123'] ?>" list="browsers" autocomplete="off" required="required">
							...
							<input type="text" class="form-control border-0 p-3" name="city" placeholder="<?php echo $lang['langs_010124'] ?>">
						</div>
						
						<div class="input-group u-rounded-50 border u-of-hidden u-mb-20">
							<input type="text" class="form-control border-0 p-3" name="postal" placeholder="<?php echo $lang['langs_010125'] ?>">
						...
						<div class="text-left">
							<label class="custom-control custom-checkbox text-left">
								...
								<span class="custom-control-description"><?php echo $lang['langs_010127'] ?> <a class="text-primary" href="terms-and-privacy.php" target="_blank"><?php echo $lang['langs_010128'] ?></a> <?php echo $lang['langs_010129'] ?></span>
							</label>
						</div>

							<button type="submit" class="btn btn-primary btn-rounded u-mt-20 u-w-310" name="dosubmit" >
