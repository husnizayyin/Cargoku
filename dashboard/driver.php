...
<head>
    ...
    <title><?php echo $lang['driver-list'] ?> | <?php echo $core->site_name ?></title>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title"><?php echo $lang['driver-list'] ?> | <?php include("filter.php");?></h4>
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
				 ...
				 <?php (Filter::$do && file_exists(Filter::$do.".php")) ? include(Filter::$do.".php") : include("main_driver.php");?>
