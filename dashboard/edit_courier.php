									...
									<div class="row">									
										...
										<div class="col-sm-12 col-md-4">
											...
											<div class="input-group">
												...
												<input type='text' class="form-control" id='datetimepicker1' name="collection_courier" placeholder="<?php echo $lang['edit-courier11'] ?>" value="<?php echo $row->collection_courier;?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo $lang['add-title10'] ?>" />
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="col-sm-12 col-md-6">										
											...
											<div class="input-group-prepend">
												...
												<input type="hidden" class="form-control" name="order_inv" value="<?php echo $row->order_inv;?>" readonly>
											</div>
										</div>
